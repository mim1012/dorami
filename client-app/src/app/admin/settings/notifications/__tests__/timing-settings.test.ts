import { getNotificationTimingSettings } from '../timing-settings';

describe('getNotificationTimingSettings', () => {
  it('groups order confirmation delay and cart reminder timing under notification settings', () => {
    expect(getNotificationTimingSettings()).toEqual([
      {
