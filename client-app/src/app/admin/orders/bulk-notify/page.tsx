    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          'Failed to send notifications. Please check your CSV format.',
      );
    } finally {
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="bg-info-bg border border-info/20 rounded-2xl p-6 mb-6">
        ...
        <div className="space-y-2">
          <Body className="text-info text-sm">1. Download the sample CSV template below</Body>
          <Body className="text-info text-sm">2. Fill in your Order IDs and Tracking Numbers</Body>
      ...
      <div className="bg-content-bg rounded-2xl p-6 border border-white/5 mb-6">
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="csv-file" className="block text-sm font-medium text-primary-text mb-2">
              Select CSV File
            </label>
            <input
              id="csv-file"
