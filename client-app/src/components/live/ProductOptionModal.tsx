          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                disabled={quantity <= 1}
                className="w-10 h-10 bg-primary-black hover:bg-white/10 disabled:opacity-30 disabled:cursor-not-allowed rounded-full flex items-center justify-center transition-colors"
              >
