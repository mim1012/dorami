...
export function FloatingNav() {
  ...
  const navItems = [
    { icon: Bell, label: '공지', onClick: () => router.push('/alerts'), title: '공지사항' },
    { icon: User, label: '프로필', onClick: () => router.push('/my-page'), title: '회원정보' },
    { icon: Package, label: '주문', onClick: () => router.push('/orders'), title: '주문내역' },
    {
      icon: MessageCircle,
      label: '문의',
