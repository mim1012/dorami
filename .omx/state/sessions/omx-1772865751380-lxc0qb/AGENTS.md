...
<session_context>
**Session:** omx-1772865751380-lxc0qb | 2026-03-07T06:42:31.677Z

**Codebase Map:**
scripts/: chaos-test, generate-comprehensive-report, load-test-hls, load-test-websocket, load-test, network-simulation-test, performance-test, smoke-check, soak-test, analyzer
backend/: ecosystem.config, eslint.config, jest.config, prisma.config, seed, night-qa-db-drift, night-qa-load-test, ralph-phase5-report-parser, re-encrypt-addresses, app.controller
client-app/: add-to-cart.spec, admin-audit-log.spec, admin-broadcasts.spec, admin-live-product-card.spec, admin-live-product-realtime.spec, admin-management.spec, admin-orders-management.spec, admin-payment-confirmation.spec, admin-product-concurrent-cart-timer.spec, admin-product-timer-stock.spec
docs/: fix-excalidraw-v2
infrastructure/: hls-load-test, staging-load-test, websocket-load-test
packages/: events, mainpage
tmp-test-esm/: a, b
(root): check-mainpage, view-users
