...
export class SubscribeNotificationDto {
  @ApiPropertyOptional({ description: 'Live stream ID to subscribe to (null for all)', example: 'stream-uuid' })
  @IsOptional()
  @IsString()
  liveStreamId?: string;

  @ApiProperty({ description: 'Push subscription endpoint', example: 'https://fcm.googleapis.com/...' })
  @IsString()
  @IsNotEmpty()
  endpoint: string;
...
export class UnsubscribeNotificationDto {
  @ApiProperty({ description: 'Push subscription endpoint to remove', example: 'https://fcm.googleapis.com/...' })
  @IsString()
  @IsNotEmpty()
  endpoint: string;
}
