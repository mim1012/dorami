...
describe('ProductsService', () => {
  ...
  describe('create', () => {
    it('should create a new product', async () => {
      ...
      const mockProduct = {
        ...
        price: { toNumber: () => 10000, toString: () => '10000' },
    ...
    it('should persist imported products as sold out and hidden from store when requested', async () => {
      const createDto = {
        streamKey: 'test-stream-key',
  ...
  describe('findByStreamKey', () => {
    ...
    it('should include hidden products for admin workflows when requested', async () => {
      jest.spyOn(prisma.product, 'findMany').mockResolvedValue([mockProduct] as any);

      await service.findByStreamKey('stream-abc', undefined, false, { includeHidden: true });
